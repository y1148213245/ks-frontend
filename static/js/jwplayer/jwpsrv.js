window.CLOSURE_NO_DEPS = true; (function () {
    ...
    function n(b, a, c, e) {
        this.f = u; this.extend = window.jwplayer.utils.extend; this.G = "../core/js/jwplayer/jwpsrv_frq.js"; this.H = e; this.debug = a; this.O = c; this.B = 0; this.C = "p pt pd pm pi pf ps psf psl psd pk pkl pkd pkt pkc pkp b bp bpb bpr bl ble blb bat bal bdt bfb bfp bhp bsp bsv sth stn ste stu stf bar bas bcr bht bte bpy bph bpf brt bsk bwi a acv acg at ak am an av ad ap ab abp abm abo abl abn aci acw ach y ym yp g gi gt s sl sc sh r rf ro rc rh rd c cc cs cf co cb ct ce cw cd m mb ms mt l lf lh ll lm lp".split(" "); this.A =
            "dev.jwpltx.com"; this.F = ""; this.D = "../core/js/jwplayer/ping.gif?"; this.d = window.jwplayer.utils.exists; this.e = b; this.u = new window.jwplayer.utils.scriptloader(this.G); this.u.load(); l.setSampleFrequency = l.setSampleFrequency || function (b) { l.sampling_frequency = parseFloat(b) }; l.parseConfig = l.parseConfig || w(this)
    }
    function w(b) {
        return function (a) {
    ...
    function U(b, a) { var c = { file: null, label: null, type: null, "default": null }, e = b.extend({}, c); b.f(c, function (c) { b.d(a[c]) && (e[c] = a[c], delete a[c]) }); return e } function fa(b, a) { var c = { file: null, label: null, kind: "captions", "default": !1 }, e = b.extend({}, c); b.f(c, function (c) { b.d(a[c]) && (e[c] = a[c], delete a[c]) }); return e } function S(b, a, c, e) { b.d(a[e]) && (c[e] = a[e], delete a[e]) }; function V(b, a, c) { this.key = b; this.value = a; this.w = c } V.prototype.getKey = function () { return this.key }; function u(b, a) { var c, e; for (c in b) "function" == window.jwplayer.utils.typeOf(b.hasOwnProperty) ? b.hasOwnProperty(c) && (e = b[c], a(c, e)) : (e = b[c], a(c, e)) }; function ga(b) {
        if (window.jwplayer._tracker) return window.jwplayer._tracker; window.jwplayer._tracker = this; this.h = {}; this.M = ""; this.L = "../core/js/jwplayer/ping.gif?"; this.K = window.jwplayer.version; if (this.q = window.top === window.self ? 0 : 1) { this.j = document.referrer; try { this.j = this.j || window.top.location.href, this.k = window.top.document.title } catch (a) { } } this.j = this.j || window.location.href; this.k = this.k || document.title; this.trackerVersion = 8; this.v = "complete" == document.readyState; this.n =
