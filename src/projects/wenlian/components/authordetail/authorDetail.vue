<template>
  <div class="components_authordetail_authordetail">
    <div class="zzxq_con pt25 pr12 pb25 pl12">
      <dl class="zzxq_detail">
        ...
        <dd class="fl">
          ...
          <components_authordetail_picinfolist :topic="authorInfo.information_SYS_TOPIC" :namespace="namespace"></components_authordetail_picinfolist>
        </dd>
        <div class="clear"></div>
      </dl>
...
<script>
  ...
  export default {
    name: "components_authordetail_authordetail",
    reused:true,
    props:["namespace"],
    data:function(){
      return {
