...
export default {
  ...
  methods: {
    getSearchResult: function (params) {
      ...
      let vCONFIG = PROJECT_CONFIG[this.namespace].search.search_result_content_03;
      let param = query.category !== '0' ? Object.assign({}, vCONFIG.paramsSpecific) : Object.assign({}, vCONFIG.paramsAll);
      ...
      Post(CONFIG.BASE_URL+vCONFIG.url, param).then((req) => {
