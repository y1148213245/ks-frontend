...
var prod = {
  ...
  review: { // 查询作品评论列表
    queryreview: {
      url: 'http://172.19.36.70:9092/spc-portal-web/' + 'comment/getWorksComment.do',
      params: {
        resourceType: '',
        resourceId: '',
        type: '1', //1：老师  2：普通
    ...
    addreview: { // 添加作品评论 索引库里面没有作品
      url: 'http://172.19.36.70:9092/spc-portal-web/' + 'comment/addWorksComment.do',
      params: {
        pubId: '', //  所以pubId为空
        loginName: '',
        content: '',
  ...
  review: { // 查询活动评论列表
    queryreview: {
      url: 'http://172.19.36.70:9092/spc-portal-web/' + 'comment/comments.do',
      params: {
        pubId: '',
        pageIndex: 1,
        pageSize: 15,
    ...
    addreview: { // 添加资讯、图书、活动评论（索引库里有）
      url: 'http://172.19.36.70:9092/spc-portal-web/' + 'comment/addComment.do',
      params: {
        pubId: '',
        loginName: '',
        content: '',
