...
var state = {
  ...
  relateBook: [],
  getCartAmount: {},
  prodbDetail:{}/* prodb图书详情 */
};

var getters = {
  prodbDetail: (state) => state.prodbDetail,
...
var actions = {
  ...
  /* 获取prodb图书详情 */
  [type.PRODB_BOOK_DETAIL]({ commit, dispatch }, params){
    api.getProdbDetail(params,({ bookDetailInfo })=>{
      commit(type.PRODB_BOOK_DETAIL, bookDetailInfo)
    })
  },
...
var mutations = {
  ...
  [type.PRODB_BOOK_DETAIL]:(state, bookDetailInfo)=>{
    return state.prodbDetail = bookDetailInfo
  },
