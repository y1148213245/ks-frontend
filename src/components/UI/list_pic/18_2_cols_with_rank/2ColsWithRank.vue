...
<style>
  ...
  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .img_wrapper img {
    height: 193px;
    width: 130px;
    text-align: center;
    position: absolute;
  ...
  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper {
    padding-left: 163px;
  }

  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper .title_wrapper .title {
    display: inline-block;
    width: 80px;
    overflow: hidden;
    white-space: nowrap;
  ...
  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper ._star {
    margin-bottom: 10px;
    margin-top: 2px;
  }

  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper ._star .el-rate {
    height: 20px;
    line-height: 1;
  }

  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper ._star .el-rate .el-rate__item {
  ...
  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper ._star .el-rate .el-rate__item .el-rate__icon {
    margin-right: 6px;
  ...
  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper .author {
    margin-bottom: 10px;
    width: 200px;
    overflow: hidden;
    white-space: nowrap;
  ...
  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper .synopsis {
    display: -webkit-box;
  ...
  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper .operate {
    line-height: 28px;
  }

  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper .operate ._share {
    display: inline-block;
    height: 28px;
    width: 38px;
    text-indent: -9999px;
  ...
  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper .operate ._buy {
    display: inline-block;
    width: 52px;
    height: 30px;
    text-align: center;
  ...
  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper .operate ._view {
    display: inline-block;
    width: 52px;
    height: 30px;
    text-align: center;
  ...
  .ui_list_pic_18_2_cols_with_rank .main_box .list_wrapper .content .attr_wrapper .index {
    display: inline-block;
    height: 30px;
    width: 30px;
    line-height: 30px;
  ...
  .ui_list_pic_18_2_cols_with_rank_skin .main_box .breadcrumbs_wrapper .breadcrumbs {
    border-bottom: 2px solid #da0b2d;
    font-size: 14px;
    color: #9b9b9b;
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .breadcrumbs_wrapper .breadcrumbs .index {
    color: #9b9b9b;
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .breadcrumbs_wrapper .breadcrumbs .ebook {
    color: #9b9b9b;
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .breadcrumbs_wrapper .breadcrumbs .current {
    color: #626262;
  }
  ...
  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .img_wrapper {

  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .img_wrapper img {
    cursor: pointer;
    box-shadow: 0 0 15px #e8e8e8;
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .attr_wrapper .title_wrapper {
    font-size: 16px;
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .attr_wrapper .title_wrapper .title {
    color: #494949;
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .attr_wrapper ._star .el-rate .el-rate__item {
    cursor: auto;
    font-size: 0;
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .attr_wrapper ._star .el-rate .el-rate__item .el-rate__icon {
    font-size: 12px;
    color: rgb(247, 186, 42);
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .attr_wrapper .author {
    color: #727272;
    font-size: 14px;
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .attr_wrapper .synopsis {
    color: #727272;
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .attr_wrapper .operate {
  ...
  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .attr_wrapper .operate ._buy {
    background: #c50000;
    font-size: 12px;
    color: #fff;
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .attr_wrapper .operate ._view {
    background: #515151;
    font-size: 12px;
    color: #fff;
  }

  .ui_list_pic_18_2_cols_with_rank_skin .main_box .list_wrapper .content .attr_wrapper .index {
    color: #fff;
