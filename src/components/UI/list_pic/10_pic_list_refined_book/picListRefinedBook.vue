...
export default {
  ...
  methods: {
    ...
    freeRead (bookId, readType, bookName) {
      //				后期切换成指定页面
      window.location.href = this.CONFIG.READ_URL || CONFIG.READ_URL + '?bookId=' + bookId + '&readType=' + readType + '&bookName=' + bookName + '&userName=&siteType=' + CONFIG.READ_CONFIG.siteType;
    },
