  ...
  <div class="ui_list_pic_31">
    ...
    <div class="ui_list_pic_31_resourcelists">
      <ul class="ui_list_pic_31_resourcelists_ul" v-if="resourceLists && resourceLists.length > 0">
        <li class="ui_list_pic_31_resourcelists_li ui_list_pic_31_resourcelists_toggleElement" v-for="(item, index) in resourceLists" :key="index" v-if="index >= resourceListsConfig.startNum && resourceListsConfig" @mouseenter="toggleDisplay(item, index)" :class="{ui_list_pic_31_resourcelists_toggleShow: hoverIndex == index && resourceListsConfig.hasHoverEvent == true}">
          <span class="ui_list_pic_31_resourcelists_li_rank"> {{index + 1}} </span>
          <template v-for="(config, config_i) in resourceListsConfig.complicatedItem" v-if="config.hoverEvent == 'false' && hoverIndex !== index">
            ...
            <span :key="config_i" v-else-if="config.name == 'button'" v-bind="{class: 'ui_list_pic_31_resourcelists_btncontainer_' + config.field + '_' + config_i}" @click="toCustomFun(item, config)">
              ...
              <span v-bind="{class: 'ui_list_pic_31_resourcelists__btncontainer_' + config.field}" v-if="keys[config.field]">{{ item[keys[config.field]] }}</span>
            </span>
...
<style>
.ui_list_pic_31_resourcelists_ul {
  list-style-type: none;
}

.ui_list_pic_31_resourcelists_toggleElement {
  padding: 10px;
  height: 40px;
  overflow: hidden;
...
.ui_list_pic_31_resourcelists_toggleShow {
  height: 180px;
}

.ui_list_pic_31_resourcelists_ul .ui_list_pic_31_resourcelists_li:nth-child(1) .ui_list_pic_31_resourcelists_li_rank, .ui_list_pic_31_resourcelists_ul .ui_list_pic_31_resourcelists_li:nth-child(2) .ui_list_pic_31_resourcelists_li_rank,.ui_list_pic_31_resourcelists_ul .ui_list_pic_31_resourcelists_li:nth-child(3) .ui_list_pic_31_resourcelists_li_rank {
  color: red;
}
