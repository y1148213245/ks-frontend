 ...
 * @Last Modified time: 2018-06-19 11:30:08
 * 通过手机号找回密码
 */
 <template>
  <div class="ui_work_findpassword_01">
    ...
    <div class="ui_work_findpassword_01_first" v-if="showItem == 'default'">
      <van-cell-group class="ui_work_findpassword_01_group">
        <van-field class="ui_work_findpassword_01_phone" v-model="phoneNumber" :placeholder="display.phoneNumber" icon="clear" @click-icon="phoneNumber = ''" @blur="formatPhoneNumber(false)" type="tel" maxlength="11" />
        <van-field class="ui_work_findpassword_01_check" v-model="checkNumber" :placeholder="display.checkNumber" center>
