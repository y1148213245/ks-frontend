 ...
 * @Last Modified time: 2018-11-09 17:15:00
 * 余额充值
...
export default {
  ...
  created() {
    this.CONFIG =
      PROJECT_CONFIG[
        this.namespace
      ].work_mobile_personalcenter.work_mobile_personalcenter_04;
  ...
  methods: {
    ...
    goToWXPay(item, index) {
      ...
      Get(CONFIG.BASE_URL + rechargeConfig.url, { params: paramsObj }).then(
        resp => {
          let datas = resp.data;
          if (datas.result == "1") {
            // 请求成功
