<template>
  <div class="work_mobile_personalcenter_12">
    ...
    <ul class="work_mobile_personalcenter_12_ul">
      <li class="work_mobile_personalcenter_12_li" v-for="(item, index) in list" :key="index">
    ...
    <van-dialog v-model="show" :showConfirmButton="isShowConfirmButton" :showCancelButton="isShowCancelButton" :closeOnClickOverlay="isCloseOnClickOverlay" :before-close="beforeClose" v-if="showEditDialog">

      <van-address-edit :area-list="areaList" :show-delete="showDelete" :address-info="addressInfo" :show-postal="isShowPostal" :show-set-default="isShowDefault" :tel-validator="telValidator" @save="onSave" @delete="onDelete">
      </van-address-edit>
